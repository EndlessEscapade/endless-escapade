...
public class FishermansLogUIState : UIState
{
    ...
    public override void OnInitialize() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            float padding = 15f; // Fuck around with these values
            int elementsPerRow = 5; // and see what looks good ig
            ...
            List<List<int>> individualPages = SplitList(allCatches, elementsPerColumn * elementsPerRow);

            FishermansLogGrid Grid = GridContainer.AddElement(new FishermansLogGrid(padding, elementSize, elementsPerRow, elementsPerColumn, individualPages[currentPage + i]));
