    ...
    public partial class Seamap
    {
        ...
        public static void RenderSeamapUI(SpriteBatch spriteBatch) {
            ...
            spriteBatch.Draw(targetTex,
                ...
                - Main.screenPosition,
                null, Color.White, Main.GameUpdateCount / 120f, new Vector2(targetTex.Width / 2, targetTex.Height / 2), 1, SpriteEffects.None, 0);
        ...
        static void RenderWater(SpriteBatch spriteBatch) {
            ...
            Texture2D waterTexture = ModContent.Request<Texture2D>("EndlessEscapade/Textures/Pure").Value;
            ...
            Effect WaterShaderBase = EndlessEscapade.Instance.Assets.Request<Effect>("Assets/Effects/WaterShaderBase", AssetRequestMode.ImmediateLoad).Value;
            ...
            Effect WaterShader = EndlessEscapade.Instance.Assets.Request<Effect>("Assets/Effects/WaterShader", AssetRequestMode.ImmediateLoad).Value;
        ...
        static void RenderClouds(SpriteBatch spriteBatch) {
            ...
            Texture2D waterTexture = ModContent.Request<Texture2D>("EndlessEscapade/Particles/Pure").Value;
            ...
            Effect SeamapCloudShader = EndlessEscapade.Instance.Assets.Request<Effect>("Assets/Effects/SeamapCloudShader", AssetRequestMode.ImmediateLoad).Value;
            ...
            Effect SeamapBorderVignette = EndlessEscapade.Instance.Assets.Request<Effect>("Assets/Effects/SeamapBorderVignette", AssetRequestMode.ImmediateLoad).Value;
