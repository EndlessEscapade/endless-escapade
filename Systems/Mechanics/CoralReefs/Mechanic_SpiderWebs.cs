...
namespace EEMod
{
    public class SpiderWebs : ModSystem
    {
        ...
        void HandleWebDraw(Vector2 position)
        {
            ...
            Texture2D vineTexture = ModContent.GetInstance<EEMod>().Assets.Request<Texture2D>("Textures/Vines/VineShorter").Value;
            Texture2D bigVineTexture = ModContent.GetInstance<EEMod>().Assets.Request<Texture2D>("Textures/Vines/BigVine").Value;
