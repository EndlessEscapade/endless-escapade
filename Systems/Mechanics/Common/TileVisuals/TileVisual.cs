...
namespace EEMod
{
    ...
    public class Leaf : TileObjVisual
    {
        ...
        public override void PreAI()
        {
            ...
            Texture2D leaft = ModContent.GetInstance<EEMod>().Assets.Request<Texture2D>("Particles/ForegroundParticles/Leaf").Value;
