...
namespace EEMod.Seamap.Content
{
    public class Glacier : Island
    {
        ...
        public override Texture2D islandTex => ModContent.Request<Texture2D>("EEMod/Seamap/SeamapAssets/Glacier", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
