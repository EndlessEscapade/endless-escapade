...
namespace EEMod.Seamap.Content.Islands
{
    public class VolcanoIsland : Island
    {
        ...
        public override Texture2D islandTex => ModContent.Request<Texture2D>("EEMod/Seamap/Content/Islands/VolcanoIsland", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
