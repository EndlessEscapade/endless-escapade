...
{
    public class Rainforest1Tile : EETile
    {
        ...
        {
            Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Rainforest1>());
        }
    }
}