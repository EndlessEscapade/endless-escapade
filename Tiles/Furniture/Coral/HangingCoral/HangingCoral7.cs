...
{
    public class HangingCoral7TE : ModTileEntity
    {
    ...
    public class HangingCoral7 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (tile != null && tile.active() && tile.type == Type)
            {
                ...
                int index = ModContent.GetInstance<HangingCoral7TE>().Find(i, j - tile.frameY / 16);
                if (index == -1)
                {
                    return;
                }
                HangingCoral7TE TE = (HangingCoral7TE)TileEntity.ByID[index];
                ...
                for (int k = 0; k < 7; k++)
                {
                    Main.spriteBatch.Draw(mod.GetTexture("Tiles/Furniture/Coral/HangingCoral/HangingCoral7Glow"), position, rect, color, 0f, default, 1f, SpriteEffects.None, 0f);
                }
            }
        }
    }
