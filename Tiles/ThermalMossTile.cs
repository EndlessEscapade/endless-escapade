...
namespace EEMod.Tiles
{
    public class ThermalMossTile : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = EEMod.instance.GetTexture("Tiles/ThermalMossTileGlow");
