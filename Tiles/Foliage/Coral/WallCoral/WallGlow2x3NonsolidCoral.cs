...
namespace EEMod.Tiles.Foliage.Coral.WallCoral
{
    public class WallGlow2x3NonsolidCoralL : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(EEMod.instance.GetTexture("Tiles/Foliage/Coral/WallCoral/WallGlow2x3NonsolidCoralLGlow"), position, rect, color, 0f, default, 1f, SpriteEffects.None, 0f);
        }
    }
    ...
    public class WallGlow2x3NonsolidCoralR : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 position = new Vector2(i * 16 - (int)Main.screenPosition.X + offsetX - (width - 16f) / 2f, j * 16 - (int)Main.screenPosition.Y + offsetY) + zero;
            Rectangle rect = new Rectangle(frameX, frameY, width, height);
            Main.spriteBatch.Draw(EEMod.instance.GetTexture("Tiles/Foliage/Coral/WallCoral/WallGlow2x3NonsolidCoralRGlow"), position, rect, color, 0f, default, 1f, SpriteEffects.None, 0f);
        }
    }
}