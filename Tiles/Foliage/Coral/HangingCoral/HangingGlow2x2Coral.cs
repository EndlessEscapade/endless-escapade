...
{
    public class HangingGlow2x2Coral : EETile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.GetInstance<EEMod>().Assets.Request<Texture2D>("Tiles/Foliage/Coral/HangingCoral/HangingGlow2x2CoralGlow").Value;
