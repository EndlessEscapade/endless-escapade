...
namespace EEMod.Projectiles
{
    public class VolcanoArrowProj : EEProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)  //this make the projectile sprite rotate perfectaly around the player
        {
            ...
            Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, null, Color.Red * (float)((255 - Projectile.alpha) / (double)255), Projectile.rotation, new Vector2(texture.Width / 2, texture.Height / 2), 1f, Projectile.spriteDirection == 1 ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0f);
            return false;
        }
    }
}