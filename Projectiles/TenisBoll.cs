...
namespace EEMod.Projectiles
{
    public class TenisBoll : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            {
                if (k != 0 && projectile.velocity.Length() > 2)
                {
                    ...
                    spriteBatch.Draw(Main.projectileTexture[projectile.type], drawPos, new Rectangle(0, 0, projectile.width, projectile.height), new Color(255, 255, 255, 10), projectile.rotation, drawOrigin, projectile.scale * (1 - (k / (float)projectile.oldPos.Length)), SpriteEffects.None, 0f);
                }
            }
            return true;
        }
