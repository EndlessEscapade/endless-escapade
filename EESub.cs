...

{
...

	{
		...
		public static Mod Prophecy = null;



		public static bool Loaded => Prophecy != null;
...

		{
			...
			return Prophecy.Call("Enter", id) as bool?;
...

		{
			...
			return Prophecy.Call("Exit") as bool?;
		...
		{
			if (!Loaded) return null;
			return Prophecy.Call("IsActive", id) as bool?;
...

		{
			...
			return Prophecy.Call("AnyActive", mod) as bool?;
...

		{
			...
			Prophecy = ModLoader.GetMod("SubworldLibrary");

				object result = Prophecy.Call(

					"Register",

					/*Mod mod*/ ModContent.GetInstance<EEMod>(),

					/*string name*/ "ProphetSubworld",
					...
					/*ModWorld modWorld*/ ModContent.GetInstance<EESubworld>()
