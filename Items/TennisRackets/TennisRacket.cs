...
namespace EEMod.Items.TennisRackets
{
    public class TennisRacket : EEItem
    {
        ...
        public override void HoldItem(Player player)
        {
            ...
            {
                proj = Projectile.NewProjectile(new Terraria.DataStructures.ProjectileSource_Item(player, Item), player.Center, Vector2.Zero, ModContent.ProjectileType<TennisRacketProj>(), 0, 0f, player.whoAmI);
                yeet = 1;
