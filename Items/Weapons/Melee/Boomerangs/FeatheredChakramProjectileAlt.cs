...
namespace EEMod.Items.Weapons.Melee.Boomerangs
{
    public class FeatheredChakramProjectileAlt : EEProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(EEMod.Instance.Assets.Request<Texture2D>("Textures/Extra_49").Value, Projectile.Center - Main.screenPosition, null, new Color(LerpColour.R, LerpColour.G, LerpColour.B, 0), 0f, new Vector2(50, 50), Math.Abs(0.33f * (sineAdd + 1)) * Projectile.ai[1], SpriteEffects.None, 0f);
            return true;
        }
