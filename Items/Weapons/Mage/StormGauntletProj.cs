...
namespace EEMod.Items.Weapons.Mage
{
    public class StormGauntletProj : EEProjectile
    {
        ...
        private void DoTheThing(Vector2 pos)
        {
            ...
            {
                int lightningproj = Projectile.NewProjectile(new ProjectileSource_ProjectileParent(Projectile), pos, new Vector2((float)Math.Sin(i), (float)Math.Cos(i)) * 15f, ModContent.ProjectileType<AxeLightning>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
