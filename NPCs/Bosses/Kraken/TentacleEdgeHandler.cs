...
namespace EEMod.NPCs.Bosses.Kraken
{
    ...
    float x0, float x1, float x2, float x3)
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            daFlop = ((float)Math.Sin(krakenHead.npc.ai[2] / 20f) * 100) + 100;
            ...
            if (krakenHead.hasChains)
            {
                ...
                {
                    if (npcBase.ai[1] != 4 || (npcBase.ai[0] > (krakenHead.dashPositions.Length - 1) * 50 && npcBase.ai[1] == 4))
                    {
                    ...
                    else
                    {
                        ...
                        startingPoint[i] += ((endingPoint[i] + new Vector2(100, 0)) - startingPoint[i]) / 64f;
                    }
