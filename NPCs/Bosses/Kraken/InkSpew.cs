        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] == 1)
            {
                ...
                if (projectile.ai[0] > 1f)
                {
                    ...
                    {
                        int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), 1, 1, DustID.Blood, projectile.velocity.X * 1.2f, projectile.velocity.Y, 0, Color.Black, 2.4f);
                        Main.dust[dust].noGravity = true;
                        int dust2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), 1, 1, DustID.Blood, projectile.velocity.X * 1.2f, projectile.velocity.Y, 9, Color.Black, 2f);
                        Main.dust[dust].noGravity = true;
                    }
                }
                else
