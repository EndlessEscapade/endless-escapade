...
namespace EEMod.Compatibility
{
    ...
    public static class EESub
    {
        ...
        public static Mod EEMod = null;

        public static bool Loaded => EEMod != null;

        public static bool? Enter(string id)
        {
            if (!Loaded) return null;
            return EEMod.Call("Enter", id) as bool?;
        }

        public static bool? Exit()
        {
            if (!Loaded) return null;
            return EEMod.Call("Exit") as bool?;
        }

        public static bool? IsActive(string id)
        {
            if (!Loaded) return null;
            return EEMod.Call("IsActive", id) as bool?;
        }

        public static bool? AnyActive(Mod mod)
        {
            if (!Loaded) return null;
            return EEMod.Call("AnyActive", mod) as bool?;
        }
        ...
        {
            EEMod = ModLoader.GetMod("SubworldLibrary");
            object result = EEMod.Call(
                "Register",
