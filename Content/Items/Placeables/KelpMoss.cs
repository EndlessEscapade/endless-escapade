...
public class KelpMoss : ModItem
{
    ...
    public override bool? UseItem(Player player) {
        ...
        WorldGen.PlaceTile(Player.tileTargetX, Player.tileTargetY, ModContent.TileType<Tiles.KelpMoss>(), false, true);
    ...
    private static bool IsHoveringRock() {
        ...
        return tile.HasTile && tile.TileType == ModContent.TileType<Tiles.KelpRock>();
    }
}
